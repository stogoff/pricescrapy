...
class ProvanceShopSpider(scrapy.Spider):
    name = 'provance-shop'
    allowed_domains = ['provance-shop.ru']
    ...
    def start_requests(self):
        with open(self.settings['INPUT_FILENAME']) as f:
            for line in f.readlines():
                ...
                print(art)
                url = 'https://provance-shop.ru/?subcats=Y&pcode_from_q=Y&pshort=Y&pfull=Y&pname=Y&pkeywords=Y&search_performed=Y&q={}&dispatch=products.search'.format(
                    art)
